...
const StyledProfileThumb = styled(Image)`
  border-radius: 50% 50%;
`
...
const gravatar = memoize(
  email => `https://www.gravatar.com/avatar/${md5(email.trim().toLowerCase())}?d=robohash`
)
